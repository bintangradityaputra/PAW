...
<head>
    ...
    <title>Form Tambah Pengajar</title>
...
<body style="background-color: #0BD7FE;">
    ...
    <div class="container" style="background: rgba(21, 16, 16, 0.5);color :white;padding :30px; border-radius:20px;text-align :center">
        <h1 style="text-align: center; color :white;">Form Tambah Data Pengajar</h1>
        <h1 style="text-align: center; color :white;">PAUD Bumi Pertiwi</h1>
        <form action="action.php" method="post">
            Nama Pengajar :<br> <input type="text" name="namaPengajar"> <br>
            <br>
            Alamat :<br> <input type="text" name="alamatPengajar"> <br>
            <br>
            NIP :<br> <input type="text" name="Nip"> <br>
            <br>
            Nomor Telepon :<br> <input type="text" name="telpPengajar"> <br>
            <br>
