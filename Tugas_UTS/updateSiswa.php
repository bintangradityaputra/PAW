...
<body style="background-color: #0BD7FE;">
    ...
    <div class="container" style="background: rgba(21, 16, 16, 0.5);color :white;padding :30px; border-radius:20px;text-align :center">
        ...
        $sql = "UPDATE datasiswa SET namaSiswa='$namaSiswa', alamat='$alamatSiswa', namaOrtu='$namaOrtu', noTelpon='$noTelpon' WHERE idSiswa = $idSiswa";
        ...
        ?>
        <br> <br> <br>
        <h1>Data Telah Berhasil Diubah!!</h1>
